...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-applicationautoscaling", "1.15.0", __name__, "aws-applicationautoscaling@1.15.0.jsii.tgz")
...
class ScalableTarget(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-applicationautoscaling.ScalableTarget"):
    ...
    def scalable_target_id(self) -> str:
        ...
        Example::
            # Example may have issues. See https://github.com/aws/jsii/issues/826
            service / ecs_stack - MyECSCluster - AB12CDE3F4GH / ecs_stack - MyECSService - AB12CDE3F4GH | ecsservice:DesiredCount|ecs
        """
        return jsii.get(self, "scalableTargetId")
