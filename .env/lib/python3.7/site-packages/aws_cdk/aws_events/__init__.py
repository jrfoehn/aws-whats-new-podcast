...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-events", "1.15.0", __name__, "aws-events@1.15.0.jsii.tgz")
...
__all__ = ["CfnEventBus", "CfnEventBusPolicy", "CfnEventBusPolicyProps", "CfnEventBusProps", "CfnRule", "CfnRuleProps", "CronOptions", "EventField", "EventPattern", "IRule", "IRuleTarget", "OnEventOptions", "Rule", "RuleProps", "RuleTargetConfig", "RuleTargetInput", "RuleTargetInputProperties", "Schedule", "__jsii_assembly__"]
