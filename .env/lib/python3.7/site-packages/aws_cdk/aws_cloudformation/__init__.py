...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-cloudformation", "1.15.0", __name__, "aws-cloudformation@1.15.0.jsii.tgz")
...
class CustomResourceProps():
    ...
    def provider(self) -> "CustomResourceProvider":
        ...
        Example::
            ...
            CustomResourceProvider.topic(my_topic)
        """
...
class NestedStack(aws_cdk.core.Stack, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudformation.NestedStack"):
    ...
    def stack_id(self) -> str:
        ...
        Example::
            # Example may have issues. See https://github.com/aws/jsii/issues/826
            arn:aws:cloudformation:us-east-2123456789012stack / mystack - mynestedstack - sggfrhxhum7w / f449b250 - b969 - 11e0 - a185 - 5081d0136786
        """
...
__all__ = ["CfnCustomResource", "CfnCustomResourceProps", "CfnMacro", "CfnMacroProps", "CfnStack", "CfnStackProps", "CfnWaitCondition", "CfnWaitConditionHandle", "CfnWaitConditionProps", "CloudFormationCapabilities", "CustomResource", "CustomResourceProps", "CustomResourceProvider", "NestedStack", "NestedStackProps", "__jsii_assembly__"]
